> 📌 **Cross-listed:** Primary location is [Linked List/2130-Maximum-Twin-Sum-of-a-Linked-List](../../Linked-List/2130-Maximum-Twin-Sum-of-a-Linked-List). This problem also appears under: **Linked List**, **Two Pointers**, **Stack**
