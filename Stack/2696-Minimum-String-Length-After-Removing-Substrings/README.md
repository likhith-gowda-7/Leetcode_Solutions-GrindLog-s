> 📌 **Cross-listed:** Primary location is [String/2696-Minimum-String-Length-After-Removing-Substrings](../../String/2696-Minimum-String-Length-After-Removing-Substrings). This problem also appears under: **String**, **Stack**, **Simulation**
