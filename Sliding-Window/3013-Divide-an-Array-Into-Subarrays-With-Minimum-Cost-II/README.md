> 📌 **Cross-listed:** Primary location is [Array/3013-Divide-an-Array-Into-Subarrays-With-Minimum-Cost-II](../../Array/3013-Divide-an-Array-Into-Subarrays-With-Minimum-Cost-II). This problem also appears under: **Array**, **Hash Table**, **Sliding Window**, **Heap (Priority Queue)**
...
| Metric | Value |
|:-------|:------|
| ⏱️ Runtime | 3554 ms (Beats 5.43%) |
| 💾 Memory | 32.1 MB (Beats 93.8%) |
| 📅 Solved | 2026-02-02 |
| 💻 Language | Python |