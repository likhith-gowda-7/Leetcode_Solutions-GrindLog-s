> 📌 **Cross-listed:** Primary location is [Linked List/2487-Remove-Nodes-From-Linked-List](../../Linked-List/2487-Remove-Nodes-From-Linked-List). This problem also appears under: **Linked List**, **Stack**, **Recursion**, **Monotonic Stack**
