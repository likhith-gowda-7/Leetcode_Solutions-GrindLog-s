> 📌 **Cross-listed:** Primary location is [Tree/0703-Kth-Largest-Element-in-a-Stream](../../Tree/0703-Kth-Largest-Element-in-a-Stream). This problem also appears under: **Tree**, **Design**, **Binary Search Tree**, **Heap (Priority Queue)**, **Binary Tree**, **Data Stream**
