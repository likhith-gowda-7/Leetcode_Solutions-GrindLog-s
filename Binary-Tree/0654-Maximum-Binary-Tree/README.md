> 📌 **Cross-listed:** Primary location is [Array/0654-Maximum-Binary-Tree](../../Array/0654-Maximum-Binary-Tree). This problem also appears under: **Array**, **Divide and Conquer**, **Stack**, **Tree**, **Monotonic Stack**, **Binary Tree**
