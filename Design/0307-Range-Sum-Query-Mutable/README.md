> 📌 **Cross-listed:** Primary location is [Array/0307-Range-Sum-Query-Mutable](../../Array/0307-Range-Sum-Query-Mutable). This problem also appears under: **Array**, **Divide and Conquer**, **Design**, **Binary Indexed Tree**, **Segment Tree**
