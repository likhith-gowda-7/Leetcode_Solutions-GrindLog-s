> 📌 **Cross-listed:** Primary location is [Stack/0225-Implement-Stack-using-Queues](../../Stack/0225-Implement-Stack-using-Queues). This problem also appears under: **Stack**, **Design**, **Queue**
