> 📌 **Cross-listed:** Primary location is [Two Pointers/0295-Find-Median-from-Data-Stream](../../Two-Pointers/0295-Find-Median-from-Data-Stream). This problem also appears under: **Two Pointers**, **Design**, **Sorting**, **Heap (Priority Queue)**, **Data Stream**
