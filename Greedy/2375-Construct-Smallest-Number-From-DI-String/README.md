> 📌 **Cross-listed:** Primary location is [String/2375-Construct-Smallest-Number-From-DI-String](../../String/2375-Construct-Smallest-Number-From-DI-String). This problem also appears under: **String**, **Backtracking**, **Stack**, **Greedy**
