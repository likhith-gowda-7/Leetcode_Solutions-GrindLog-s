> 📌 **Cross-listed:** Primary location is [Binary Search/3600-Maximize-Spanning-Tree-Stability-with-Upgrades](../../Binary-Search/3600-Maximize-Spanning-Tree-Stability-with-Upgrades). This problem also appears under: **Binary Search**, **Greedy**, **Union-Find**, **Graph Theory**, **Minimum Spanning Tree**
