> 📌 **Cross-listed:** Primary location is [Array/2161-Partition-Array-According-to-Given-Pivot](../../Array/2161-Partition-Array-According-to-Given-Pivot). This problem also appears under: **Array**, **Two Pointers**, **Simulation**
