> 📌 **Cross-listed:** Primary location is [Array/2196-Create-Binary-Tree-From-Descriptions](../../Array/2196-Create-Binary-Tree-From-Descriptions). This problem also appears under: **Array**, **Hash Table**, **Tree**, **Binary Tree**
