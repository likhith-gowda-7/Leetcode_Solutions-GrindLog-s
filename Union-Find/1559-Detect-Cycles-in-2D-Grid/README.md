> 📌 **Cross-listed:** Primary location is [Array/1559-Detect-Cycles-in-2D-Grid](../../Array/1559-Detect-Cycles-in-2D-Grid). This problem also appears under: **Array**, **Depth-First Search**, **Breadth-First Search**, **Union-Find**, **Matrix**
...
| Metric | Value |
|:-------|:------|
| ⏱️ Runtime | 281 ms (Beats 70.28%) |
| 💾 Memory | 53.5 MB (Beats 96.42%) |
| 📅 Solved | 2026-04-26 |
| 💻 Language | Python |