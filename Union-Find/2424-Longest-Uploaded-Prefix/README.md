> 📌 **Cross-listed:** Primary location is [Hash Table/2424-Longest-Uploaded-Prefix](../../Hash-Table/2424-Longest-Uploaded-Prefix). This problem also appears under: **Hash Table**, **Binary Search**, **Union-Find**, **Design**, **Binary Indexed Tree**, **Segment Tree**, **Heap (Priority Queue)**, **Ordered Set**
