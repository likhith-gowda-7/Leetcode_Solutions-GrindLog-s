> 📌 **Cross-listed:** Primary location is [Depth-First Search/1971-Find-if-Path-Exists-in-Graph](../../Depth-First-Search/1971-Find-if-Path-Exists-in-Graph). This problem also appears under: **Depth-First Search**, **Breadth-First Search**, **Union-Find**, **Graph Theory**
