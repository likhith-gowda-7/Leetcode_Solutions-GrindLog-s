> 📌 **Cross-listed:** Primary location is [Array/0108-Convert-Sorted-Array-to-Binary-Search-Tree](../../Array/0108-Convert-Sorted-Array-to-Binary-Search-Tree). This problem also appears under: **Array**, **Divide and Conquer**, **Tree**, **Binary Search Tree**, **Binary Tree**
