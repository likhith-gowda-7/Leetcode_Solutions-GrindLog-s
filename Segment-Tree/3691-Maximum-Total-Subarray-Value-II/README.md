> 📌 **Cross-listed:** Primary location is [Array/3691-Maximum-Total-Subarray-Value-II](../../Array/3691-Maximum-Total-Subarray-Value-II). This problem also appears under: **Array**, **Greedy**, **Segment Tree**, **Heap (Priority Queue)**
