> 📌 **Cross-listed:** Primary location is [Array/2812-Find-the-Safest-Path-in-a-Grid](../../Array/2812-Find-the-Safest-Path-in-a-Grid). This problem also appears under: **Array**, **Binary Search**, **Breadth-First Search**, **Union-Find**, **Heap (Priority Queue)**, **Matrix**
