> 📌 **Cross-listed:** Primary location is [Tree/0226-Invert-Binary-Tree](../../Tree/0226-Invert-Binary-Tree). This problem also appears under: **Tree**, **Depth-First Search**, **Breadth-First Search**, **Binary Tree**
