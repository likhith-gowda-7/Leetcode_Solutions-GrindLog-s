> 📌 **Cross-listed:** Primary location is [Depth-First Search/2492-Minimum-Score-of-a-Path-Between-Two-Cities](../../Depth-First-Search/2492-Minimum-Score-of-a-Path-Between-Two-Cities). This problem also appears under: **Depth-First Search**, **Breadth-First Search**, **Union-Find**, **Graph Theory**
