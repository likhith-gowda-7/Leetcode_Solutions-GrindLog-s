> 📌 **Cross-listed:** Primary location is [Tree/0530-Minimum-Absolute-Difference-in-BST](../../Tree/0530-Minimum-Absolute-Difference-in-BST). This problem also appears under: **Tree**, **Depth-First Search**, **Breadth-First Search**, **Binary Search Tree**, **Binary Tree**
