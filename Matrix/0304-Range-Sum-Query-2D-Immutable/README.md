> 📌 **Cross-listed:** Primary location is [Array/0304-Range-Sum-Query-2D-Immutable](../../Array/0304-Range-Sum-Query-2D-Immutable). This problem also appears under: **Array**, **Design**, **Matrix**, **Prefix Sum**
