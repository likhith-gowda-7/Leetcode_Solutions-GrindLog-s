> 📌 **Cross-listed:** Primary location is [Hash Table/0424-Longest-Repeating-Character-Replacement](../../Hash-Table/0424-Longest-Repeating-Character-Replacement). This problem also appears under: **Hash Table**, **String**, **Sliding Window**
