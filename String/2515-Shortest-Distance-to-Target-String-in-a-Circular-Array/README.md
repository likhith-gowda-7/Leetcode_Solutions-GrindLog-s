> 📌 **Cross-listed:** Primary location is [Array/2515-Shortest-Distance-to-Target-String-in-a-Circular-Array](../../Array/2515-Shortest-Distance-to-Target-String-in-a-Circular-Array). This problem also appears under: **Array**, **String**
