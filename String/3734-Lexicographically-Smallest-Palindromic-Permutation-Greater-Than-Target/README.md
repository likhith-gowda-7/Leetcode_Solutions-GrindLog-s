> 📌 **Cross-listed:** Primary location is [Two Pointers/3734-Lexicographically-Smallest-Palindromic-Permutation-Greater-Than-Target](../../Two-Pointers/3734-Lexicographically-Smallest-Palindromic-Permutation-Greater-Than-Target). This problem also appears under: **Two Pointers**, **String**, **Enumeration**
