> 📌 **Cross-listed:** Primary location is [Hash Table/1790-Check-if-One-String-Swap-Can-Make-Strings-Equal](../../Hash-Table/1790-Check-if-One-String-Swap-Can-Make-Strings-Equal). This problem also appears under: **Hash Table**, **String**, **Counting**
