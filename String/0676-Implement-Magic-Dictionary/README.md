> 📌 **Cross-listed:** Primary location is [Hash Table/0676-Implement-Magic-Dictionary](../../Hash-Table/0676-Implement-Magic-Dictionary). This problem also appears under: **Hash Table**, **String**, **Depth-First Search**, **Design**, **Trie**
