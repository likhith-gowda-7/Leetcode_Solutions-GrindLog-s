> 📌 **Cross-listed:** Primary location is [Hash Table/0865-Smallest-Subtree-with-all-the-Deepest-Nodes](../../Hash-Table/0865-Smallest-Subtree-with-all-the-Deepest-Nodes). This problem also appears under: **Hash Table**, **Tree**, **Depth-First Search**, **Breadth-First Search**, **Binary Tree**
