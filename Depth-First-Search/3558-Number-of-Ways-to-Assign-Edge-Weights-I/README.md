> 📌 **Cross-listed:** Primary location is [Math/3558-Number-of-Ways-to-Assign-Edge-Weights-I](../../Math/3558-Number-of-Ways-to-Assign-Edge-Weights-I). This problem also appears under: **Math**, **Tree**, **Depth-First Search**
...
| Metric | Value |
|:-------|:------|
| ⏱️ Runtime | 351 ms (Beats 55.13%) |
| 💾 Memory | 124.2 MB (Beats 14.88%) |
| 📅 Solved | 2026-06-13 |
| 💻 Language | Python |