> 📌 **Cross-listed:** Primary location is [Tree/0110-Balanced-Binary-Tree](../../Tree/0110-Balanced-Binary-Tree). This problem also appears under: **Tree**, **Depth-First Search**, **Binary Tree**
