> 📌 **Cross-listed:** Primary location is [Hash Table/0133-Clone-Graph](../../Hash-Table/0133-Clone-Graph). This problem also appears under: **Hash Table**, **Depth-First Search**, **Breadth-First Search**, **Graph Theory**
