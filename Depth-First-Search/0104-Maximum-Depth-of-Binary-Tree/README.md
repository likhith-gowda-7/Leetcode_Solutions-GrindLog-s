> 📌 **Cross-listed:** Primary location is [Tree/0104-Maximum-Depth-of-Binary-Tree](../../Tree/0104-Maximum-Depth-of-Binary-Tree). This problem also appears under: **Tree**, **Depth-First Search**, **Breadth-First Search**, **Binary Tree**
