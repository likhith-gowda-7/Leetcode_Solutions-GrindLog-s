> 📌 **Cross-listed:** Primary location is [Tree/0100-Same-Tree](../../Tree/0100-Same-Tree). This problem also appears under: **Tree**, **Depth-First Search**, **Breadth-First Search**, **Binary Tree**
