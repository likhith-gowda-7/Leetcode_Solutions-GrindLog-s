> 📌 **Cross-listed:** Primary location is [Hash Table/2840-Check-if-Strings-Can-be-Made-Equal-With-Operations-II](../../Hash-Table/2840-Check-if-Strings-Can-be-Made-Equal-With-Operations-II). This problem also appears under: **Hash Table**, **String**, **Sorting**
