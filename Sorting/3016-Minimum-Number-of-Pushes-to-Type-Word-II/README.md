> 📌 **Cross-listed:** Primary location is [Hash Table/3016-Minimum-Number-of-Pushes-to-Type-Word-II](../../Hash-Table/3016-Minimum-Number-of-Pushes-to-Type-Word-II). This problem also appears under: **Hash Table**, **String**, **Greedy**, **Sorting**, **Counting**
