> 📌 **Cross-listed:** Primary location is [Array/1877-Minimize-Maximum-Pair-Sum-in-Array](../../Array/1877-Minimize-Maximum-Pair-Sum-in-Array). This problem also appears under: **Array**, **Two Pointers**, **Greedy**, **Sorting**
