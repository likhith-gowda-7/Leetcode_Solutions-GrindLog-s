> 📌 **Cross-listed:** Primary location is [Hash Table/0138-Copy-List-with-Random-Pointer](../../Hash-Table/0138-Copy-List-with-Random-Pointer). This problem also appears under: **Hash Table**, **Linked List**
