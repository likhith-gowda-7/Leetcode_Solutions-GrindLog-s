> 📌 **Cross-listed:** Primary location is [Array/3411-Maximum-Subarray-With-Equal-Products](../../Array/3411-Maximum-Subarray-With-Equal-Products). This problem also appears under: **Array**, **Math**, **Sliding Window**, **Enumeration**, **Number Theory**
