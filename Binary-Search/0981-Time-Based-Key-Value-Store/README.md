> 📌 **Cross-listed:** Primary location is [Hash Table/0981-Time-Based-Key-Value-Store](../../Hash-Table/0981-Time-Based-Key-Value-Store). This problem also appears under: **Hash Table**, **String**, **Binary Search**, **Design**
