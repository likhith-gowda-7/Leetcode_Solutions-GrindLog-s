> 📌 **Cross-listed:** Primary location is [Array/0239-Sliding-Window-Maximum](../../Array/0239-Sliding-Window-Maximum). This problem also appears under: **Array**, **Queue**, **Sliding Window**, **Heap (Priority Queue)**, **Monotonic Queue**
