> 📌 **Cross-listed:** Primary location is [Two Pointers/3302-Find-the-Lexicographically-Smallest-Valid-Sequence](../../Two-Pointers/3302-Find-the-Lexicographically-Smallest-Valid-Sequence). This problem also appears under: **Two Pointers**, **String**, **Dynamic Programming**, **Greedy**
