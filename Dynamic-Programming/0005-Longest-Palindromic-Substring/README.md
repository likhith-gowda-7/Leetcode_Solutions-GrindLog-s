> 📌 **Cross-listed:** Primary location is [Two Pointers/0005-Longest-Palindromic-Substring](../../Two-Pointers/0005-Longest-Palindromic-Substring). This problem also appears under: **Two Pointers**, **String**, **Dynamic Programming**
