> 📌 **Cross-listed:** Primary location is [Array/1048-Longest-String-Chain](../../Array/1048-Longest-String-Chain). This problem also appears under: **Array**, **Hash Table**, **Two Pointers**, **String**, **Dynamic Programming**, **Sorting**
...
| Metric | Value |
|:-------|:------|
| ⏱️ Runtime | 787 ms (Beats 19.6%) |
| 💾 Memory | 19.5 MB (Beats 69.9%) |
| 📅 Solved | 2026-06-21 |
| 💻 Language | Python |