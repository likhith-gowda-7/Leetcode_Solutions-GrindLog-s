> 📌 **Cross-listed:** Primary location is [String/1653-Minimum-Deletions-to-Make-String-Balanced](../../String/1653-Minimum-Deletions-to-Make-String-Balanced). This problem also appears under: **String**, **Dynamic Programming**, **Stack**
