> 📌 **Cross-listed:** Primary location is [Array/1578-Minimum-Time-to-Make-Rope-Colorful](../../Array/1578-Minimum-Time-to-Make-Rope-Colorful). This problem also appears under: **Array**, **String**, **Dynamic Programming**, **Greedy**
