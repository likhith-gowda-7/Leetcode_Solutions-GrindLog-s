> 📌 **Cross-listed:** Primary location is [Array/3375-Minimum-Operations-to-Make-Array-Values-Equal-to-K](../../Array/3375-Minimum-Operations-to-Make-Array-Values-Equal-to-K). This problem also appears under: **Array**, **Hash Table**
