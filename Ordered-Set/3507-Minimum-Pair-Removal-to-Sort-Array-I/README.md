> 📌 **Cross-listed:** Primary location is [Array/3507-Minimum-Pair-Removal-to-Sort-Array-I](../../Array/3507-Minimum-Pair-Removal-to-Sort-Array-I). This problem also appears under: **Array**, **Hash Table**, **Linked List**, **Heap (Priority Queue)**, **Simulation**, **Doubly-Linked List**, **Ordered Set**
