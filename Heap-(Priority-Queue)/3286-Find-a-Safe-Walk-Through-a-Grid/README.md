> 📌 **Cross-listed:** Primary location is [Array/3286-Find-a-Safe-Walk-Through-a-Grid](../../Array/3286-Find-a-Safe-Walk-Through-a-Grid). This problem also appears under: **Array**, **Breadth-First Search**, **Graph Theory**, **Heap (Priority Queue)**, **Matrix**, **Shortest Path**
