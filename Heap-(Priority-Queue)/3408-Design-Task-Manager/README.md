> 📌 **Cross-listed:** Primary location is [Hash Table/3408-Design-Task-Manager](../../Hash-Table/3408-Design-Task-Manager). This problem also appears under: **Hash Table**, **Design**, **Heap (Priority Queue)**, **Ordered Set**
